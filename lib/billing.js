...
function buildBillingFromRecords(records = []) {
  ...
  return { source: { spreadsheet: '5067', tabs: ['Paket', 'Area', 'ODP', 'pelanggan', 'Sheet8'], formulas: ['OLT/PON parsing', 'ODP VLOOKUP', 'ODP capacity COUNTIF', 'package price lookup'], storage: 'Supabase synchronized records' }, customers, summary: summarize(customers) };
}
